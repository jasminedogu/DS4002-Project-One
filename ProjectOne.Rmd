...
```{r}
df_all_levels <- df[, which(names(df) %in% c("opinion_h1n1_risk","health_worker","opinion_h1n1_vacc_effective","age_group","education","h1n1_concern","opinion_h1n1_sick_from_vacc","doctor_rec_h1n1","child_under_6_months","race"))]
```
...
df_onehot = as.data.frame(as.matrix(sparse.model.matrix(~. -1, data = df_all_levels)))
