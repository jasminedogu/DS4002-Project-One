...
# Creating the Training and Training Sets
```{r}
...
```
The optimal SVM and Random Forest Models identified earlier were run ten different times, having removed the seed. These results will then be fed into the Wilcoxon Rank-Sum Test. 
