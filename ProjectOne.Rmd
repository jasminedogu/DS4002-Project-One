...
1. This research project focused on specifically the Swine Flu pandemic. For future analysis, completing a similar analysis on data collected from other pandemics and epidemics could be critical. By building models and exploring the topology of the datasets, the data scientist may be able to gain some insight as to what factors make a person more likely to get vaccinated during a pandemic. This is especially important to understand given the current state of the world in regards to the COVID-19 pandemic. In the future as new viruses emerge, having a clear understanding of the factors that contribute to an individual getting a vaccination will become increasingly important. 
